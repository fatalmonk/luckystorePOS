/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e20cd3807fb36999eb8098af92371bb0)
...
interface __BaseEnv_Env {
	...
	COMPETITOR_SCRAPE_WORKFLOW: Workflow<Parameters<import("./src/index").CompetitorScrapeWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTOMATION_ENABLED" | "WORKFLOW_VERSION" | "STORE_ALLOWLIST" | "SUPABASE_URL" | "CHALDAL_SOURCE_APPROVED" | "SHWAPNO_SOURCE_APPROVED">> {}
}
