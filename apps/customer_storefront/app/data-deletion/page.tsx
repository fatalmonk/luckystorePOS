...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.luckystore1947.com/data-deletion',
  },
};
...
function PolicySection({ icon, title, children }: PolicySectionProps) {
  return (
    <section className="bg-warm-surface border border-warm-border rounded-[var(--radius-md)] p-5 sm:p-6 shadow-sm">
          ...
          <div className="space-y-4 mb-10">
            ...
            <PolicySection icon="✉️" title="How to Request Data Deletion">
              ...
              <div className="bg-warm-bg border border-warm-border rounded-[var(--radius-md)] p-4 my-2">
                <p><strong>Email:</strong> <a href="mailto:hello@luckystore1947.com" className="text-warm-accent-dark font-semibold underline underline-offset-2 hover:no-underline">hello@luckystore1947.com</a></p>
            ...
            <PolicySection icon="📞" title="Contact Us">
              ...
              <ul className="list-disc pl-4 space-y-1">
                <li>Email: <a href="mailto:hello@luckystore1947.com" className="text-warm-accent-dark font-semibold underline underline-offset-2 hover:no-underline">hello@luckystore1947.com</a></li>
