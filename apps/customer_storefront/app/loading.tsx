    ...
    <>
      ...
      <main className="flex-1 overflow-y-auto overflow-x-hidden pb-16">
        <div className="p-4 sm:p-6 space-y-6">
          ...
          <div className="h-32 sm:h-40 bg-gray-200 rounded-xl animate-pulse" />
            ...
            <div className="flex gap-4 overflow-x-hidden">
              {Array.from({ length: 4 }).map((_, i) => (
                <div key={i} className="w-40 sm:w-48 flex-shrink-0">
                  <div className="h-32 bg-gray-200 rounded-[14px] animate-pulse mb-2" />
                  <div className="h-4 w-20 bg-gray-200 rounded animate-pulse mb-1" />
                  <div className="h-4 w-3/4 bg-gray-200 rounded animate-pulse mb-2" />
                  <div className="h-9 w-full bg-gray-200 rounded-full animate-pulse" />
                </div>
              ))}
            </div>
          </div>
