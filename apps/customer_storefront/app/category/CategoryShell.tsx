...
const BANNER_MAP: Record<string, { title: string; subtitle: string; badge: string; bgImage: any }> = {
  ...
  'rice-and-grain': {
    ...
    subtitle: 'Finest Miniket, Chinigura, and Nazirshail rice at fair bazaar rates in Chittagong.',
    badge: 'Daily Rice & Grains',
    bgImage: responsiveHeroBanner('promo_cooking', 'Rice & Grains'),
  },
  'oil-and-ghee': {
    title: 'Pure Mustard & Soybean Oils',
    subtitle: 'Authentic sealed bottles of Teer, Rupchanda soybean, pure mustard oil, and ghee in Chittagong.',
    badge: 'Edible Oils & Ghee',
    bgImage: responsiveHeroBanner('promo_cooking', 'Oil & Ghee'),
  },
  'cooking-essentials': {
    title: 'Daily Bazaar & Pantry Staples',
    subtitle: 'Everyday cooking essentials: lentils, flour, spices, salt & sugar at local bazaar rates.',
  ...
  'tea-coffee': {
    title: 'Ispahani Tea & Coffee Blends',
    subtitle: 'Aromatic teas, premium coffee blends, and garden-fresh leaves with prompt local dispatch.',
    badge: 'Morning Brew',
