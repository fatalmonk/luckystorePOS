...
export function WhatsAppFloat() {
  ...
  return (
    <Link
      ...
      className="fixed bottom-20 right-4 z-40 w-12 h-12 rounded-full bg-[#25D366] text-white shadow-lg flex items-center justify-center hover:scale-105 active:scale-95 transition-transform duration-200 md:hidden"
    >
