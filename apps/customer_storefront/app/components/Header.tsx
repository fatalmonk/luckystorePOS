  ...
  return (
    <header className="sticky top-0 z-50 h-[68px] bg-[#FFF34D] border-b border-yellow-300 flex items-center px-4 gap-3 flex-shrink-0">
      ...
      <div className="flex items-center gap-3 flex-shrink-0">
        ...
        <button
          type="button"
          className="hidden md:flex flex-col items-start text-xs text-[#5c5200] hover:bg-yellow-400/60 px-2 py-1 rounded-lg transition-colors min-h-[44px] justify-center"
        >
          <span className="text-[9px] uppercase tracking-wider text-[#5c5200]/70 font-semibold">Delivery to</span>
