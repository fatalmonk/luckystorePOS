...
CREATE OR REPLACE FUNCTION "public"."check_idempotency"("p_key" "text", "p_tenant_id" "uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
DECLARE
...
CREATE OR REPLACE FUNCTION "public"."create_reminder"("p_tenant_id" "uuid", "p_store_id" "uuid", "p_title" "text", "p_description" "text", "p_reminder_date" "date", "p_reminder_type" "text", "p_created_by" "uuid" DEFAULT NULL::"uuid") RETURNS "public"."reminders"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
DECLARE
...
CREATE OR REPLACE FUNCTION "public"."deduct_stock"("p_store_id" "uuid", "p_product_id" "uuid", "p_quantity" integer, "p_metadata" "jsonb" DEFAULT '{}'::"jsonb") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
DECLARE
...
CREATE OR REPLACE FUNCTION "public"."delete_reminder"("p_reminder_id" "uuid") RETURNS boolean
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
BEGIN
...
CREATE OR REPLACE FUNCTION "public"."get_current_user_store_id"() RETURNS "uuid"
...
CREATE OR REPLACE FUNCTION "public"."get_expected_cash"("p_tenant_id" "uuid", "p_store_id" "uuid", "p_account_id" "uuid", "p_date" "date" DEFAULT CURRENT_DATE) RETURNS numeric
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
DECLARE
...
CREATE OR REPLACE FUNCTION "public"."get_offline_sync_status"("p_order_ids" "uuid"[]) RETURNS TABLE("order_id" "uuid", "is_synced" boolean, "synced_at" timestamp without time zone)
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
BEGIN
...
ALTER FUNCTION "public"."get_offline_sync_status"("p_order_ids" "uuid"[]) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."get_receipt_config_simple"("p_store_id" "uuid") RETURNS "public"."receipt_config"
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
...
CREATE OR REPLACE FUNCTION "public"."get_sale_details"("p_sale_id" "uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
DECLARE
...
CREATE OR REPLACE FUNCTION "public"."get_sales_history"("p_store_id" "uuid", "p_search_query" "text" DEFAULT NULL::"text", "p_start_date" timestamp with time zone DEFAULT NULL::timestamp with time zone, "p_end_date" timestamp with time zone DEFAULT NULL::timestamp with time zone, "p_limit" integer DEFAULT 50, "p_offset" integer DEFAULT 0) RETURNS TABLE("id" "uuid", "sale_number" "text", "total_amount" numeric, "status" "text", "cashier_name" "text", "created_at" timestamp with time zone)
    LANGUAGE "plpgsql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
BEGIN
...
CREATE OR REPLACE FUNCTION "public"."get_stock_level_by_id"("p_store_id" "uuid", "p_item_id" "uuid") RETURNS TABLE("store_id" "uuid", "item_id" "uuid", "quantity" integer, "recent_movements" "jsonb")
...
CREATE OR REPLACE FUNCTION "public"."get_store_users"("p_store_id" "uuid") RETURNS TABLE("id" "uuid", "full_name" "text", "role" "text", "email" "text", "last_login" timestamp with time zone)
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
...
CREATE OR REPLACE FUNCTION "public"."get_upcoming_reminders"("p_store_id" "uuid", "p_include_completed" boolean DEFAULT false) RETURNS SETOF "public"."reminders"
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
    SELECT r.*
...
CREATE OR REPLACE FUNCTION "public"."log_stock_ledger_on_update"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
BEGIN
...
CREATE OR REPLACE FUNCTION "public"."post_draft_purchase_receipt"("p_receipt_id" "uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
DECLARE
...
CREATE OR REPLACE FUNCTION "public"."record_cash_closing"("p_idempotency_key" "text", "p_tenant_id" "uuid", "p_store_id" "uuid", "p_account_id" "uuid", "p_actual_cash" numeric, "p_date" "date" DEFAULT CURRENT_DATE, "p_notes" "text" DEFAULT NULL::"text") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."record_purchase"("p_idempotency_key" "text", "p_tenant_id" "uuid", "p_store_id" "uuid", "p_supplier_id" "uuid", "p_invoice_number" "text", "p_invoice_total" numeric, "p_items" "jsonb", "p_amount_paid" numeric, "p_payment_account_id" "uuid", "p_payable_account_id" "uuid", "p_status" "text", "p_notes" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."record_purchase_v2"("p_idempotency_key" "text", "p_tenant_id" "uuid", "p_store_id" "uuid", "p_supplier_id" "uuid", "p_invoice_number" "text" DEFAULT NULL::"text", "p_invoice_total" numeric DEFAULT NULL::numeric, "p_items" "jsonb" DEFAULT '[]'::"jsonb", "p_amount_paid" numeric DEFAULT 0, "p_payment_account_id" "uuid" DEFAULT NULL::"uuid", "p_payable_account_id" "uuid" DEFAULT NULL::"uuid", "p_status" "text" DEFAULT 'posted'::"text", "p_notes" "text" DEFAULT NULL::"text") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
DECLARE
...
CREATE OR REPLACE FUNCTION "public"."sync_offline_orders"("p_orders" "jsonb") RETURNS TABLE("order_id" "uuid", "status" "text", "message" "text")
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."sync_offline_orders"("p_orders" "jsonb") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."sync_user_name"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
BEGIN
...
ALTER FUNCTION "public"."sync_user_name"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."update_receipt_config_simple"("p_store_id" "uuid", "p_store_name" "text", "p_header_text" "text", "p_footer_text" "text") RETURNS "public"."receipt_config"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
BEGIN
...
CREATE OR REPLACE FUNCTION "public"."update_reminder"("p_reminder_id" "uuid", "p_title" "text" DEFAULT NULL::"text", "p_description" "text" DEFAULT NULL::"text", "p_reminder_date" "date" DEFAULT NULL::"date", "p_reminder_type" "text" DEFAULT NULL::"text", "p_is_completed" boolean DEFAULT NULL::boolean) RETURNS "public"."reminders"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
DECLARE
...
CREATE OR REPLACE TRIGGER "audit_stock_levels_ins" AFTER INSERT OR DELETE OR UPDATE ON "public"."stock_levels" FOR EACH ROW EXECUTE FUNCTION "public"."log_audit"();



CREATE OR REPLACE TRIGGER "audit_stock_movements_ins" AFTER INSERT OR DELETE OR UPDATE ON "public"."stock_movements" FOR EACH ROW EXECUTE FUNCTION "public"."log_audit"();
...
CREATE OR REPLACE TRIGGER "tr_sync_user_name" BEFORE INSERT OR UPDATE OF "full_name" ON "public"."users" FOR EACH ROW EXECUTE FUNCTION "public"."sync_user_name"();
...
CREATE OR REPLACE TRIGGER "trg_log_stock_ledger" AFTER UPDATE ON "public"."stock_levels" FOR EACH ROW WHEN (("new"."qty" IS DISTINCT FROM "old"."qty")) EXECUTE FUNCTION "public"."log_stock_ledger_on_update"();
...
CREATE POLICY "competitor_prices_select_authenticated" ON "public"."competitor_prices" FOR SELECT TO "authenticated" USING (true);
...
REVOKE ALL ON FUNCTION "public"."check_idempotency"("p_key" "text", "p_tenant_id" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."check_idempotency"("p_key" "text", "p_tenant_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."check_idempotency"("p_key" "text", "p_tenant_id" "uuid") TO "service_role";



REVOKE ALL ON FUNCTION "public"."check_ledger_batch_balance"() FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."close_pos_session"("p_session_id" "uuid", "p_closing_cash" numeric) FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."create_reminder"("p_tenant_id" "uuid", "p_store_id" "uuid", "p_title" "text", "p_description" "text", "p_reminder_date" "date", "p_reminder_type" "text", "p_created_by" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."create_reminder"("p_tenant_id" "uuid", "p_store_id" "uuid", "p_title" "text", "p_description" "text", "p_reminder_date" "date", "p_reminder_type" "text", "p_created_by" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_reminder"("p_tenant_id" "uuid", "p_store_id" "uuid", "p_title" "text", "p_description" "text", "p_reminder_date" "date", "p_reminder_type" "text", "p_created_by" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."decrement_stock"("p_store_id" "uuid", "p_item_id" "uuid", "p_quantity" integer) TO "authenticated";



REVOKE ALL ON FUNCTION "public"."deduct_stock"("p_store_id" "uuid", "p_product_id" "uuid", "p_quantity" integer, "p_metadata" "jsonb") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."deduct_stock"("p_store_id" "uuid", "p_product_id" "uuid", "p_quantity" integer, "p_metadata" "jsonb") TO "authenticated";
GRANT ALL ON FUNCTION "public"."deduct_stock"("p_store_id" "uuid", "p_product_id" "uuid", "p_quantity" integer, "p_metadata" "jsonb") TO "service_role";



REVOKE ALL ON FUNCTION "public"."delete_reminder"("p_reminder_id" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."delete_reminder"("p_reminder_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."delete_reminder"("p_reminder_id" "uuid") TO "service_role";
...
REVOKE ALL ON FUNCTION "public"."enqueue_sale_for_ledger_posting_from_sales"() FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."ensure_expense_ledger_accounts"("p_store_id" "uuid") FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."generate_session_number"() FROM PUBLIC;
...
GRANT ALL ON FUNCTION "public"."get_current_user_store_id"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_current_user_store_id"() TO "service_role";
...
REVOKE ALL ON FUNCTION "public"."get_expected_cash"("p_tenant_id" "uuid", "p_store_id" "uuid", "p_account_id" "uuid", "p_date" "date") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."get_expected_cash"("p_tenant_id" "uuid", "p_store_id" "uuid", "p_account_id" "uuid", "p_date" "date") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_expected_cash"("p_tenant_id" "uuid", "p_store_id" "uuid", "p_account_id" "uuid", "p_date" "date") TO "service_role";
...
REVOKE ALL ON FUNCTION "public"."get_inventory_list"("p_store_id" "uuid") FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."get_new_receipt"("store" "uuid") FROM PUBLIC;
...
GRANT ALL ON FUNCTION "public"."get_offline_sync_status"("p_order_ids" "uuid"[]) TO "anon";
GRANT ALL ON FUNCTION "public"."get_offline_sync_status"("p_order_ids" "uuid"[]) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_offline_sync_status"("p_order_ids" "uuid"[]) TO "service_role";



REVOKE ALL ON FUNCTION "public"."get_or_create_ar_account"("p_tenant_id" "uuid") FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."get_receipt_config_simple"("p_store_id" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."get_receipt_config_simple"("p_store_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_receipt_config_simple"("p_store_id" "uuid") TO "service_role";
...
REVOKE ALL ON FUNCTION "public"."get_sale_details"("p_sale_id" "uuid") FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."get_sales_history"("p_store_id" "uuid", "p_search_query" "text", "p_start_date" timestamp with time zone, "p_end_date" timestamp with time zone, "p_limit" integer, "p_offset" integer) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."get_sales_history"("p_store_id" "uuid", "p_search_query" "text", "p_start_date" timestamp with time zone, "p_end_date" timestamp with time zone, "p_limit" integer, "p_offset" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_sales_history"("p_store_id" "uuid", "p_search_query" "text", "p_start_date" timestamp with time zone, "p_end_date" timestamp with time zone, "p_limit" integer, "p_offset" integer) TO "service_role";
...
REVOKE ALL ON FUNCTION "public"."get_stock_history_simple"("p_store_id" "uuid", "p_item_id" "uuid", "p_limit" integer) FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."get_stock_level_by_id"("p_store_id" "uuid", "p_item_id" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."get_stock_level_by_id"("p_store_id" "uuid", "p_item_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_stock_level_by_id"("p_store_id" "uuid", "p_item_id" "uuid") TO "service_role";
...
REVOKE ALL ON FUNCTION "public"."get_store_users"("p_store_id" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."get_store_users"("p_store_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_store_users"("p_store_id" "uuid") TO "service_role";
...
REVOKE ALL ON FUNCTION "public"."get_upcoming_reminders"("p_store_id" "uuid", "p_include_completed" boolean) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."get_upcoming_reminders"("p_store_id" "uuid", "p_include_completed" boolean) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_upcoming_reminders"("p_store_id" "uuid", "p_include_completed" boolean) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."import_apply_stock_delta"("p_store_id" "uuid", "p_item_id" "uuid", "p_delta" integer) TO "authenticated";



REVOKE ALL ON FUNCTION "public"."import_historical_daily_sale"("p_store_id" "uuid", "p_date" "date", "p_cash_amount" numeric, "p_bkash_amount" numeric) FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."is_period_closed"("p_store_id" "uuid", "p_posted_at" timestamp with time zone) FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."log_stock_ledger_on_update"() FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."log_stock_ledger_on_update"() TO "anon";
GRANT ALL ON FUNCTION "public"."log_stock_ledger_on_update"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."log_stock_ledger_on_update"() TO "service_role";
...
REVOKE ALL ON FUNCTION "public"."post_draft_purchase_receipt"("p_receipt_id" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."post_draft_purchase_receipt"("p_receipt_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."post_draft_purchase_receipt"("p_receipt_id" "uuid") TO "service_role";
...
REVOKE ALL ON FUNCTION "public"."prevent_sale_audit_log_mutation"() FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."record_cash_closing"("p_idempotency_key" "text", "p_tenant_id" "uuid", "p_store_id" "uuid", "p_account_id" "uuid", "p_actual_cash" numeric, "p_date" "date", "p_notes" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."record_cash_closing"("p_idempotency_key" "text", "p_tenant_id" "uuid", "p_store_id" "uuid", "p_account_id" "uuid", "p_actual_cash" numeric, "p_date" "date", "p_notes" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."record_cash_closing"("p_idempotency_key" "text", "p_tenant_id" "uuid", "p_store_id" "uuid", "p_account_id" "uuid", "p_actual_cash" numeric, "p_date" "date", "p_notes" "text") TO "service_role";
...
REVOKE ALL ON FUNCTION "public"."record_expense"("p_store_id" "uuid", "p_date" "date", "p_vendor" "text", "p_description" "text", "p_amount" numeric, "p_payment_type" "text", "p_category" "text") FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."record_purchase"("p_idempotency_key" "text", "p_tenant_id" "uuid", "p_store_id" "uuid", "p_supplier_id" "uuid", "p_invoice_number" "text", "p_invoice_total" numeric, "p_items" "jsonb", "p_amount_paid" numeric, "p_payment_account_id" "uuid", "p_payable_account_id" "uuid", "p_status" "text", "p_notes" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."record_purchase"("p_idempotency_key" "text", "p_tenant_id" "uuid", "p_store_id" "uuid", "p_supplier_id" "uuid", "p_invoice_number" "text", "p_invoice_total" numeric, "p_items" "jsonb", "p_amount_paid" numeric, "p_payment_account_id" "uuid", "p_payable_account_id" "uuid", "p_status" "text", "p_notes" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."record_purchase"("p_idempotency_key" "text", "p_tenant_id" "uuid", "p_store_id" "uuid", "p_supplier_id" "uuid", "p_invoice_number" "text", "p_invoice_total" numeric, "p_items" "jsonb", "p_amount_paid" numeric, "p_payment_account_id" "uuid", "p_payable_account_id" "uuid", "p_status" "text", "p_notes" "text") TO "service_role";



REVOKE ALL ON FUNCTION "public"."record_purchase_v2"("p_idempotency_key" "text", "p_tenant_id" "uuid", "p_store_id" "uuid", "p_supplier_id" "uuid", "p_invoice_number" "text", "p_invoice_total" numeric, "p_items" "jsonb", "p_amount_paid" numeric, "p_payment_account_id" "uuid", "p_payable_account_id" "uuid", "p_status" "text", "p_notes" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."record_purchase_v2"("p_idempotency_key" "text", "p_tenant_id" "uuid", "p_store_id" "uuid", "p_supplier_id" "uuid", "p_invoice_number" "text", "p_invoice_total" numeric, "p_items" "jsonb", "p_amount_paid" numeric, "p_payment_account_id" "uuid", "p_payable_account_id" "uuid", "p_status" "text", "p_notes" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."record_purchase_v2"("p_idempotency_key" "text", "p_tenant_id" "uuid", "p_store_id" "uuid", "p_supplier_id" "uuid", "p_invoice_number" "text", "p_invoice_total" numeric, "p_items" "jsonb", "p_amount_paid" numeric, "p_payment_account_id" "uuid", "p_payable_account_id" "uuid", "p_status" "text", "p_notes" "text") TO "service_role";
...
REVOKE ALL ON FUNCTION "public"."set_stock"("p_store_id" "uuid", "p_item_id" "uuid", "p_new_qty" integer, "p_reason" "text", "p_notes" "text") FROM PUBLIC;
...
GRANT ALL ON FUNCTION "public"."sync_offline_orders"("p_orders" "jsonb") TO "anon";
GRANT ALL ON FUNCTION "public"."sync_offline_orders"("p_orders" "jsonb") TO "authenticated";
GRANT ALL ON FUNCTION "public"."sync_offline_orders"("p_orders" "jsonb") TO "service_role";



REVOKE ALL ON FUNCTION "public"."sync_user_name"() FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."sync_user_name"() TO "anon";
GRANT ALL ON FUNCTION "public"."sync_user_name"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."sync_user_name"() TO "service_role";



REVOKE ALL ON FUNCTION "public"."update_competitor_price_timestamp"() FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."update_receipt_config_simple"("p_store_id" "uuid", "p_store_name" "text", "p_header_text" "text", "p_footer_text" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."update_receipt_config_simple"("p_store_id" "uuid", "p_store_name" "text", "p_header_text" "text", "p_footer_text" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_receipt_config_simple"("p_store_id" "uuid", "p_store_name" "text", "p_header_text" "text", "p_footer_text" "text") TO "service_role";



REVOKE ALL ON FUNCTION "public"."update_reminder"("p_reminder_id" "uuid", "p_title" "text", "p_description" "text", "p_reminder_date" "date", "p_reminder_type" "text", "p_is_completed" boolean) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."update_reminder"("p_reminder_id" "uuid", "p_title" "text", "p_description" "text", "p_reminder_date" "date", "p_reminder_type" "text", "p_is_completed" boolean) TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_reminder"("p_reminder_id" "uuid", "p_title" "text", "p_description" "text", "p_reminder_date" "date", "p_reminder_type" "text", "p_is_completed" boolean) TO "service_role";
...
REVOKE ALL ON FUNCTION "public"."update_user_last_login"() FROM PUBLIC;
...
GRANT ALL ON FUNCTION "public"."upsert_stock_level"("p_store_id" "uuid", "p_item_id" "uuid", "p_quantity" integer) TO "authenticated";
