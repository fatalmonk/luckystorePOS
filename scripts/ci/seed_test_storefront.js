...
async function runViaServiceRoleClient(url, key) {
  ...
  // 4. Products
  const products = [
    { id: 'a0740000-0000-0000-0000-000000000001', tenant_id: TENANT_ID, name: 'Miniket Rice Premium', brand: 'Lucky Store', price: 85, mrp: 95, cost: 70, category_id: 'c0000000-0000-0000-0000-000000000001', sku: 'RICE-MIN-01', barcode: '894110000001', is_active: true, image_url: '/banners/promo_welcome_v2_400.webp', description: 'Freshly polished premium Miniket rice sourced from trusted local mills in Dinajpur.' },
    { id: 'a0740000-0000-0000-0000-000000000002', tenant_id: TENANT_ID, name: 'Aarong Dairy Pure Liquid Milk', brand: 'Aarong Dairy', price: 90, mrp: 90, cost: 75, category_id: 'c0000000-0000-0000-0000-000000000002', sku: 'MILK-AAR-01', barcode: '894110000002', is_active: true, image_url: '/banners/promo_dairy_400.webp', description: 'Pasteurized 100% pure whole cows milk from Aarong Dairy.' },
    { id: 'a0740000-0000-0000-0000-000000000003', tenant_id: TENANT_ID, name: 'Fresh Farm Eggs Layer (12 pcs)', brand: 'Lucky Store', price: 145, mrp: 155, cost: 120, category_id: 'c0000000-0000-0000-0000-000000000002', sku: 'EGG-LAY-12', barcode: '894110000003', is_active: true, image_url: '/banners/promo_dairy_400.webp', description: 'Fresh farm brown layer eggs carefully graded and packed.' },
    { id: 'a0740000-0000-0000-0000-000000000004', tenant_id: TENANT_ID, name: 'Bombay Sweets Potato Crackers', brand: 'Bombay Sweets', price: 25, mrp: 25, cost: 18, category_id: 'c0000000-0000-0000-0000-000000000003', sku: 'SNK-POT-01', barcode: '894110000004', is_active: true, image_url: '/banners/promo_snacks_400.webp', description: 'Classic crispy potato chips with authentic local spice seasoning.' },
    { id: 'a0740000-0000-0000-0000-000000000005', tenant_id: TENANT_ID, name: 'Vim Dishwashing Liquid 500ml', brand: 'Vim', price: 130, mrp: 140, cost: 100, category_id: 'c0000000-0000-0000-0000-000000000004', sku: 'CLN-VIM-01', barcode: '894110000005', is_active: true, image_url: '/banners/promo_cleaning_supply_400.webp', description: 'Concentrated dishwash gel with lemon grease-cutting power.' },
    { id: 'a0740000-0000-0000-0000-000000000006', tenant_id: TENANT_ID, name: 'Pran Mustard Oil 500ml', brand: 'Pran', price: 180, mrp: 195, cost: 150, category_id: 'c0000000-0000-0000-0000-000000000005', sku: 'OIL-PRAN-500', barcode: '894110000006', is_active: true, image_url: '/banners/promo_cooking_400.webp', description: 'Pure grade-1 pungent mustard oil for traditional cooking.' },
    { id: 'a0740000-0000-0000-0000-000000000099', tenant_id: TENANT_ID, name: 'Auth test rice', brand: 'Lucky Store', price: 100, mrp: 100, cost: 80, category_id: 'c0000000-0000-0000-0000-000000000001', sku: 'AUTH-TEST-01', barcode: '894110000099', is_active: true, image_url: '/banners/promo_welcome_v2_400.webp', description: 'Deterministic test product for auth boundary and checkout test verification.' },
    { id: 'a0740000-0000-0000-0000-000000000007', tenant_id: TENANT_ID, name: 'Radhuni Turmeric Powder 200g', brand: 'Radhuni', price: 95, mrp: 95, cost: 75, category_id: 'c0000000-0000-0000-0000-000000000005', sku: 'RAD-TUR-200', barcode: '894110000007', is_active: true, image_url: '/banners/promo_cooking_400.webp', description: 'Finely milled pure turmeric powder for cooking.' },
  ];
